...
class Moment:
    ...
    def load_data(self, X, y: pd.Series, *, sensitive_features: pd.Series = None, fair_weights: pd.Series = None):
        ...
        #     X, y, sensitive_features, _fair_weights  = self._transform(X, y, sensitive_features, fair_weights)
        #     self._fair_weights = _fair_weights 
        ...
        if fair_weights is not None:
            # self.tags['weights'] = fair_weights
